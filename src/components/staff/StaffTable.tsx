...
import { staffMock as initialStaff, type StaffRow } from "@/mocks/staff";
...
export default function StaffTable() {
  ...
  const [rowToDelete, setRowToDelete] = useState<StaffRow | null>(null);
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter((r) => {
      const haystack = [r.name, r.email, r.phone, r.role, r.status, r.createdAt]
        .join(" ")
        .toLowerCase();
  ...
  return (
    <>
      ...
      {/* Delete Modal (same modal style you venís usando) */}
      <Modal
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            {rowToDelete ? `Are you sure you want to delete "${rowToDelete.name}"?` : "Are you sure?"}
          </p>
