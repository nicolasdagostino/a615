...
"[project]/src/components/athlete/reservations/reservationsMock.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$athlete$2f$reservations$2f$reservationsMock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/athlete/reservations/reservationsMock.ts [app-client] (ecmascript)");
;
...
function ReservationsProvider({ children }) {
    _s();
    const athleteId = 1;
    const [sessions, setSessions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$athlete$2f$reservations$2f$reservationsMock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sessionsMock"]);
    const [reservations, setReservations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$athlete$2f$reservations$2f$reservationsMock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reservationsMock"].filter({
        "ReservationsProvider.useState": (r)=>r.athleteId === athleteId
    }["ReservationsProvider.useState"]));
    const isReserved = (sessionId)=>reservations.some((r)=>r.sessionId === sessionId);
    const remainingSpots = (sessionId)=>{
        const s = sessions.find((x)=>x.id === sessionId);
        if (!s) return 0;
        return Math.max(0, s.capacity - s.reservedCount);
    };
    const reserve = (sessionId)=>{
        const s = sessions.find((x)=>x.id === sessionId);
        if (!s) return {
            ok: false,
        ...
        if (isReserved(sessionId)) return {
            ok: false,
            reason: "Ya estás reservado."
        };
        if (remainingSpots(sessionId) <= 0) return {
            ok: false,
            reason: "La clase está completa."
        };
        ...
        if (hasOverlap) return {
            ok: false,
            reason: "Ya tenés una clase en ese horario."
        };
        const newRes = {
            id: Date.now(),
            athleteId,
        ...
        setSessions((prev)=>prev.map((x)=>x.id === sessionId ? {
                    ...x,
                    reservedCount: x.reservedCount + 1
                } : x));
        return {
            ok: true
        };
    ...
    const cancel = (sessionId)=>{
        ...
        setSessions((prev)=>prev.map((x)=>x.id === sessionId ? {
                    ...x,
                    reservedCount: Math.max(0, x.reservedCount - 1)
                } : x));
    };
...
_s(ReservationsProvider, "Ls53L/5V2vNSuZwB15p+miKv3PY=");
...
function AthleteReservations() {
    _s();
    const { sessions, isReserved, remainingSpots, reserve, cancel } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$athlete$2f$reservations$2f$reservationsStore$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReservations"])();
    const now = new Date();
    const todayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteReservations.useMemo[todayKey]": ()=>{
    ...
    const todaySessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteReservations.useMemo[todaySessions]": ()=>{
            return sessions.filter({
                "AthleteReservations.useMemo[todaySessions]": (s)=>s.date === todayKey
            }["AthleteReservations.useMemo[todaySessions]"]).sort({
                "AthleteReservations.useMemo[todaySessions]": (a, b)=>a.time.localeCompare(b.time)
            }["AthleteReservations.useMemo[todaySessions]"]);
        }
    }["AthleteReservations.useMemo[todaySessions]"], [
        sessions,
    ...
    const [pendingCancelId, setPendingCancelId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const openCancel = (sessionId)=>{
        setPendingCancelId(sessionId);
        cancelModal.openModal();
    };
    const confirmCancel = ()=>{
        if (pendingCancelId != null) cancel(pendingCancelId);
        setPendingCancelId(null);
        cancelModal.closeModal();
    };
    const selectedToCancel = pendingCancelId != null ? sessions.find((s)=>s.id === pendingCancelId) : null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-5",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex flex-col gap-2 border-b border-gray-100 px-5 py-4 dark:border-gray-800 sm:flex-row sm:items-center sm:justify-between",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "text-sm text-gray-500 dark:text-gray-400",
                            children: todaySessions.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "font-semibold text-gray-800 dark:text-white/90",
                                        children: todaySessions.length
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                                        lineNumber: 68,
                                        columnNumber: 17
                                ...
                                children: "No hay clases cargadas para hoy."
                            }, void 0, false, {
                                fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                                lineNumber: 74,
                                columnNumber: 15
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-3",
                children: todaySessions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "rounded-2xl border border-gray-200 bg-white p-6 text-center text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400",
                    children: "Hoy no hay clases disponibles."
                }, void 0, false, {
                    fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                    lineNumber: 83,
                    columnNumber: 11
                }, this) : todaySessions.map((s)=>{
                    const reserved = isReserved(s.id);
                    const spots = remainingSpots(s.id);
                    const full = spots <= 0;
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2f$Badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    color: s.type === "Open" ? "warning" : "success",
                                                    size: "sm",
                                                    children: s.type
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        full ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "rounded-full bg-error-50 px-3 py-1 text-xs font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500",
                                            children: "Completo"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                                            lineNumber: 129,
                                            ...
                                            className: "rounded-full bg-green-50 px-3 py-1 text-xs font-medium text-green-600 dark:bg-green-500/15 dark:text-green-500",
                                            children: [
                                                "Quedan ",
                                                spots
                                            ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$modal$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Modal"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "relative z-1 mb-6 flex items-center justify-center",
                            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: selectedToCancel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    "Vas a cancelar",
                                    " ",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "font-semibold",
                                        children: selectedToCancel.title
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                                        lineNumber: 211,
                                        columnNumber: 17
                            ...
                            }, void 0, true) : "Confirmá si querés cancelar esta reserva."
                        }, void 0, false, {
                            fileName: "[project]/src/components/athlete/reservations/AthleteReservations.tsx",
                            lineNumber: 207,
                            columnNumber: 11
...
_s(AthleteReservations, "1CRb6J70xkW3ZssO8RlcGGBkc60=", false, function() {
    return [
...
//# sourceMappingURL=src_d876f6a4._.js.map