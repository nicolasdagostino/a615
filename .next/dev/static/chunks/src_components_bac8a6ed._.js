...
function AddReservationForm({ defaultValues, primaryButtonLabel = "Save Reservation" }) {
    _s();
    // Mock options (después lo conectamos con backend)
    const memberOptions = [
        {
            value: "1",
            label: "Lindsey Curtis (lindsey@gmail.com)"
        },
        {
            value: "2",
            label: "Kaiya George (kaiya@gmail.com)"
        },
        {
            value: "3",
            label: "Zain Geidt (zain@gmail.com)"
        }
    ];
    const classOptions = [
        {
            value: "101",
            label: "CrossFit — Mon 18:00"
        },
        {
            value: "102",
            label: "Open Box — Mon 19:00"
        },
        {
            value: "103",
            label: "Weightlifting — Tue 18:00"
        }
    ];
    const statusOptions = [
        {
    ...
    const initial = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AddReservationForm.useMemo[initial]": ()=>normalizeDefaults(defaultValues)
    }["AddReservationForm.useMemo[initial]"], [
        defaultValues
    ]);
...
_s(AddReservationForm, "3Mtp98tjzPo0Jqs7aizj7EyNg5o=");
...
//# sourceMappingURL=src_components_bac8a6ed._.js.map