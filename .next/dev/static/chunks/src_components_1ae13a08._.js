...
"[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AthleteWodReadOnly() {
    _s();
    const [wods, setWods] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
            date: "2026-01-01",
            ...
            comments: [
                {
                    ...
                    author: "Nico",
                    text: "Me mató el 21 😅",
                    createdAt: "01/01/2026 19:12"
                },
                {
                    id: "c2",
                    author: "Meli",
                    text: "Hoy salieron mariposas jaja",
                    createdAt: "01/01/2026 20:01"
                }
            ]
        },
        {
            ...
            comments: [
                {
                    id: "c4",
                    author: "Ana",
                    text: "Buenísimo para arrancar la semana",
                    createdAt: "29/12/2025 08:22"
                }
            ]
        }
    ]);
    ...
    const [month, setMonth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultMonth);
    const [year, setYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultYear);
    ...
    const monthOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteWodReadOnly.useMemo[monthOptions]": ()=>Array.from({
                length: 12
            }, {
                "AthleteWodReadOnly.useMemo[monthOptions]": (_, i)=>({
                        value: String(i + 1),
                        label: monthLabel(i + 1)
                    })
            }["AthleteWodReadOnly.useMemo[monthOptions]"])
    }["AthleteWodReadOnly.useMemo[monthOptions]"], []);
    const yearOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteWodReadOnly.useMemo[yearOptions]": ()=>{
            const y = defaultYear;
            return [
                y,
                y - 1,
                ...
                "AthleteWodReadOnly.useMemo[yearOptions]": (yy)=>({
                        value: String(yy),
                        label: String(yy)
                    })
            }["AthleteWodReadOnly.useMemo[yearOptions]"]);
    ...
    const listForMonth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteWodReadOnly.useMemo[listForMonth]": ()=>{
            return wods.filter({
                "AthleteWodReadOnly.useMemo[listForMonth]": (w)=>isSameMonth(w.date, year, month)
            }["AthleteWodReadOnly.useMemo[listForMonth]"]).filter({
                "AthleteWodReadOnly.useMemo[listForMonth]": (w)=>!searchText.trim() || w.content.toLowerCase().includes(searchText.trim().toLowerCase())
            }["AthleteWodReadOnly.useMemo[listForMonth]"]).sort({
                "AthleteWodReadOnly.useMemo[listForMonth]": (a, b)=>a.date < b.date ? 1 : -1
            }["AthleteWodReadOnly.useMemo[listForMonth]"]).map({
                "AthleteWodReadOnly.useMemo[listForMonth]": (w)=>({
                        date: w.date,
    ...
    const selectedWod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AthleteWodReadOnly.useMemo[selectedWod]": ()=>{
            const date = selectedDate ?? listForMonth[0]?.date ?? null;
            if (!date) return null;
            return wods.find({
                "AthleteWodReadOnly.useMemo[selectedWod]": (w)=>w.date === date
            }["AthleteWodReadOnly.useMemo[selectedWod]"]) ?? null;
        }
    }["AthleteWodReadOnly.useMemo[selectedWod]"], [
        wods,
        selectedDate,
    ...
    const addComment = ()=>{
        ...
        const created = `${pad2(createdAt.getDate())}/${pad2(createdAt.getMonth() + 1)}/${createdAt.getFullYear()} ` + `${pad2(createdAt.getHours())}:${pad2(createdAt.getMinutes())}`;
        setWods((prev)=>prev.map((w)=>w.date !== selectedWod.date ? w : {
                    ...w,
                    comments: [
                        ...w.comments,
                        {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$form$2f$input$2f$InputField$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                lineNumber: 143,
                                columnNumber: 13
                            }, this)
                        }, void 0, false, {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "Seleccioná un WOD para ver detalle y comentarios."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                        lineNumber: 190,
                                                        columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: listForMonth.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "rounded-xl border border-dashed border-gray-200 p-6 text-center text-sm text-gray-500 dark:border-gray-800 dark:text-gray-400",
                                        children: "No hay WODs para este mes (mock)."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                        lineNumber: 202,
                                        columnNumber: 17
                                        ...
                                        className: "space-y-2",
                                        children: listForMonth.map((item)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: [
                                                    ...
                                                    active ? "border-brand-300 bg-brand-500/5 dark:border-brand-800" : "border-gray-200 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-900"
                                                ].join(" "),
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: formatDateShort(item.date)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                                    lineNumber: 223,
                                                                    columnNumber: 29
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "flex shrink-0 items-center gap-1 rounded-full bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-700 dark:bg-gray-800 dark:text-gray-300",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                                    width: "16",
                                                                    height: "16",
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        className: "text-lg font-semibold text-gray-800 dark:text-white/90",
                                        children: selectedWod ? `WOD · ${formatDateShort(selectedWod.date)}` : "WOD"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                        lineNumber: 255,
                                        columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: !selectedWod ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "rounded-xl border border-dashed border-gray-200 p-6 text-center text-sm text-gray-500 dark:border-gray-800 dark:text-gray-400",
                                        children: "Seleccioná un día para ver el WOD."
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                        lineNumber: 262,
                                        columnNumber: 17
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                                    className: "whitespace-pre-wrap text-sm leading-6 text-gray-800 dark:text-white/90 font-medium",
                                                    children: selectedWod.content
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                    lineNumber: 268,
                                                    columnNumber: 21
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "text-sm text-gray-500 dark:text-gray-400",
                                                                children: selectedWod.comments.length
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                                lineNumber: 276,
                                                                columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-3",
                                                        children: selectedWod.comments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "text-sm text-gray-500 dark:text-gray-400",
                                                            ...
                                                            lineNumber: 281,
                                                            columnNumber: 25
                                                        }, this) : selectedWod.comments.map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "mb-2 text-sm font-semibold text-gray-800 dark:text-white/90",
                                                                children: "Escribir comentario"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                                lineNumber: 296,
                                                                columnNumber: 23
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: "(Mock) Se agrega en memoria; al refrescar vuelve al seed."
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/athlete/wod/AthleteWodReadOnly.tsx",
                                                                lineNumber: 307,
                                                                columnNumber: 23
...
_s(AthleteWodReadOnly, "DGK54ldHZ3WFG8L1HLeX/OtM+1M=");
_c = AthleteWodReadOnly;
var _c;
__turbopack_context__.k.register(_c, "AthleteWodReadOnly");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_components_1ae13a08._.js.map